...
import (
	...
	"github.com/MichaelPereira31/chatservice/internal/domain/entity"
	"github.com/MichaelPereira31/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	if err != nil {
		if err.Error() == "chat not found" {
			...
			if err != nil {
				return nil, errors.New("error persisting nex chat: " + err.Error())
			}
		} else {
			return nil, errors.New("error fetch chat: " + err.Error())
		}
	}
	...
	if err != nil {
		return nil, errors.New("new adding new message: " + err.Error())
	}
